...
describe 'ListEdit', ->
  ...
  describe 'findMatchingOpeningBracket', ->
    ...
    it 'works', ->
      #             012345678901
      textBuffer = '[1,[1,2,[]]]'
      expect(ListEdit.findMatchingOpeningBracket textBuffer, 11, false)
       .toEqual([1, [ [1,3] ]])
      expect(ListEdit.findMatchingOpeningBracket textBuffer, 10, false)
       .toEqual([4, [ [4,8] ]])
      expect(ListEdit.findMatchingOpeningBracket textBuffer, 9, false)
       .toEqual([9, [  ]])
      expect(ListEdit.findMatchingOpeningBracket textBuffer, 8, false)
       .toEqual([4, [ [4,8] ]])
      expect(ListEdit.findMatchingOpeningBracket textBuffer, 1, false)
       .toEqual([1, [  ]])
  ...
  describe 'findMatchingClosingBracket', ->
    ...
    it 'works', ->
      #             01234567890123
      textBuffer = '[1,[[],2,3],4]'
      expect(ListEdit.findMatchingClosingBracket textBuffer, 1, false)
       .toEqual([13, [ [1,3], [11,13] ]])
      expect(ListEdit.findMatchingClosingBracket textBuffer, 3, false)
       .toEqual([13, [ [11,13] ]])
      expect(ListEdit.findMatchingClosingBracket textBuffer, 4, false)
       .toEqual([10, [ [6,10] ]])
      expect(ListEdit.findMatchingClosingBracket textBuffer, 11, false)
       .toEqual([13, [ [11,13] ]])
      expect(ListEdit.findMatchingClosingBracket textBuffer, 0, false)
       .toEqual(null)
